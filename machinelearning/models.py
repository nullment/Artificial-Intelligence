...
class RegressionModel(Module):
    ...
    def __init__(self):
        ...
        "*** YOUR CODE HERE ***"
        super().__init__()
        self.input_layer = Linear(1, 200)
        self.output_layer = Linear(200, 1)
...
class DigitClassificationModel(Module):
    ...
    def __init__(self):
        ...
        output_size = 10
        "*** YOUR CODE HERE ***"
        self.batch_size = 32#28
        self.inputLayer = Linear(input_size, 200)
        self.outputLayer = Linear(200, output_size)
    ...
    def run(self, x):
        ...
        inputResult = self.inputLayer(x)
        outputResult = self.outputLayer(relu(inputResult))
        return outputResult
